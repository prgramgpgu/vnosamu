<nav class="shadow navbar navbar-expand-lg navbar-light mb-2 py-0" style="background-color: #e3f2fd;">
{{--    FFCBDB - для админки--}}
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <button class="btn btn-outline-info my-2 my-sm-0" type="submit"> Поиск статьи</button>
        </form>
    </div>
</nav>
